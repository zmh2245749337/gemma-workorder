...
Run this on a CUDA GPU — a Colab T4 or a local NVIDIA GPU both work. It
trains only LoRA adapters; model weights and dataset stay local to wherever
the script runs and are not committed to Git.
"""
